...
class HospitalPaymentActivity : AppCompatActivity(), AppApiCalls.OnAPICallCompleteListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        img_customerid_water.setImageDrawable(getDrawable(R.drawable.hospital))

        tts = TextToSpeech(this, this)

        text_title_water.setText("Hospital Payment")
...
//        cvBrowsePlans.setBackgroundResource(R.drawable.bg_rightcurved)
        ...
        if (flag.equals(AppConstants.OPERATOR_API)) {
            ...
            if (status.contains("true")) {
                ...
                for (i in 0 until cast.length()) {
                    ...
                    if (notifyObjJson.getString("opsertype").equals("Hospital"))
                    {
    ...
    private fun showOperatorsBottomSheet() {
        ...
        view.rvspinner.apply {
            ...
            view.rvspinner.addItemDecoration(DividerItemDecoration(this@HospitalPaymentActivity, LinearLayoutManager.VERTICAL))

            operatorAdapter = OperatorListAdapter(
                context, operatorsModelArrayList, this@HospitalPaymentActivity
            )
