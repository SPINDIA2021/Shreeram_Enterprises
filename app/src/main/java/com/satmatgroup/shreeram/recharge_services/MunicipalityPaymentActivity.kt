...
class MunicipalityPaymentActivity : AppCompatActivity(), AppApiCalls.OnAPICallCompleteListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text_title_water.setText("Municipality")
...
//        cvBrowsePlans.setBackgroundResource(R.drawable.bg_rightcurved)
        ...
        if (flag.equals(AppConstants.OPERATOR_API)) {
            ...
            if (status.contains("true")) {
                ...
                for (i in 0 until cast.length()) {
                    ...
                    if (notifyObjJson.getString("opsertype").equals("Municipality"))
                    {
    ...
    private fun showOperatorsBottomSheet() {
        ...
        view.rvspinner.apply {
            ...
            view.rvspinner.addItemDecoration(DividerItemDecoration(this@MunicipalityPaymentActivity, LinearLayoutManager.VERTICAL))

            operatorAdapter = OperatorListAdapter(
                context, operatorsModelArrayList, this@MunicipalityPaymentActivity
            )
