...
class TrafficChallanPaymentActivity : AppCompatActivity(), AppApiCalls.OnAPICallCompleteListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        img_customerid_water.setImageDrawable(getDrawable(R.drawable.traffic_challan))

        tts = TextToSpeech(this, this)

        text_title_water.setText("Traffic Challan")
...
//        cvBrowsePlans.setBackgroundResource(R.drawable.bg_rightcurved)
        ...
        if (flag.equals(AppConstants.OPERATOR_API)) {
            ...
            if (status.contains("true")) {
                ...
                for (i in 0 until cast.length()) {
                    ...
                    if (notifyObjJson.getString("opsertype").equals("Traffic Challan"))
                    {
    ...
    private fun showOperatorsBottomSheet() {
        ...
        view.rvspinner.apply {
            ...
            view.rvspinner.addItemDecoration(DividerItemDecoration(this@TrafficChallanPaymentActivity, LinearLayoutManager.VERTICAL))

            operatorAdapter = OperatorListAdapter(
                context, operatorsModelArrayList, this@TrafficChallanPaymentActivity
            )
