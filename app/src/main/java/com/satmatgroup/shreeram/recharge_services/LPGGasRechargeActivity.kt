...
class LPGGasRechargeActivity : AppCompatActivity(), AppApiCalls.OnAPICallCompleteListener,
...
//        cvBrowsePlans.setBackgroundResource(R.drawable.bg_rightcurved)
        ...
        if (flag.equals(AppConstants.OPERATOR_API)) {
            ...
            if (status.contains("true")) {
                ...
                for (i in 0 until cast.length()) {
                    ...
                    if (notifyObjJson.getString("opsertype").equals("LPG"))
                    {
    ...
    private fun showOperatorsBottomSheet() {
        ...
        view.rvspinner.apply {
            ...
            view.rvspinner.addItemDecoration(DividerItemDecoration(this@LPGGasRechargeActivity, LinearLayoutManager.VERTICAL))

            operatorAdapter = OperatorListAdapter(
                context, operatorsModelArrayList, this@LPGGasRechargeActivity
            )
