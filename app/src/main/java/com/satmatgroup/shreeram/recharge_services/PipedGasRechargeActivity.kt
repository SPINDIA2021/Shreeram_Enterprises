...
class PipedGasRechargeActivity : AppCompatActivity(), AppApiCalls.OnAPICallCompleteListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text_title_gas.setText("Piped Gas")

        image_gas.setImageDrawable(getDrawable(R.drawable.pipedgas))
...
//        cvBrowsePlans.setBackgroundResource(R.drawable.bg_rightcurved)
        ...
        if (flag.equals(AppConstants.OPERATOR_API)) {
            ...
            if (status.contains("true")) {
                ...
                for (i in 0 until cast.length()) {
                    ...
                    if (notifyObjJson.getString("opsertype").equals("Gas"))
                    {
    ...
    private fun showOperatorsBottomSheet() {
        ...
        view.rvspinner.apply {
            ...
            view.rvspinner.addItemDecoration(DividerItemDecoration(this@PipedGasRechargeActivity, LinearLayoutManager.VERTICAL))

            operatorAdapter = OperatorListAdapter(
                context, operatorsModelArrayList, this@PipedGasRechargeActivity
            )
